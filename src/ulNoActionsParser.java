...
public class ulNoActionsParser extends Parser {
	...
	// ./src/ulNoActions.g:107:1: compoundType returns [CompType ct] : (ad= arrayDecl |t= TYPE );
	public final CompType compoundType() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:109:2: (ad= arrayDecl |t= TYPE )
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// ./src/ulNoActions.g:109:5: ad= arrayDecl
					{
					...
					break;
				case 2 :
					// ./src/ulNoActions.g:111:4: t= TYPE
					{
	...
	// ./src/ulNoActions.g:115:1: arrayDecl returns [ArrayDecl ad] : t= TYPE '[' il= integerconstant ']' ;
	public final ArrayDecl arrayDecl() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:116:2: (t= TYPE '[' il= integerconstant ']' )
			// ./src/ulNoActions.g:116:4: t= TYPE '[' il= integerconstant ']'
			{
	...
	// ./src/ulNoActions.g:122:1: identifier returns [Identifier i] : id= ID ;
	public final Identifier identifier() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:123:2: (id= ID )
			// ./src/ulNoActions.g:123:4: id= ID
			{
	...
	// ./src/ulNoActions.g:128:1: statement returns [Statement s] : (st= semiColon |ec= exprColon |aas= arrayAssign |idas= idAssign |ie= ifElseBlock |is= ifBlock |wh= whileBlock |pl= printlnStmt |ps= printStmt |ret= returnStmt );
	public final Statement statement() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:129:2: (st= semiColon |ec= exprColon |aas= arrayAssign |idas= idAssign |ie= ifElseBlock |is= ifBlock |wh= whileBlock |pl= printlnStmt |ps= printStmt |ret= returnStmt )
			int alt7=10;
			switch ( input.LA(1) ) {
			case 25:
				{
			...
			switch (alt7) {
				case 1 :
					// ./src/ulNoActions.g:129:4: st= semiColon
					{
					...
					break;
				case 2 :
					// ./src/ulNoActions.g:130:4: ec= exprColon
					{
					...
					break;
				case 3 :
					// ./src/ulNoActions.g:131:4: aas= arrayAssign
					{
					...
					break;
				case 4 :
					// ./src/ulNoActions.g:132:4: idas= idAssign
					{
					...
					break;
				case 5 :
					// ./src/ulNoActions.g:133:4: ie= ifElseBlock
					{
					...
					break;
				case 6 :
					// ./src/ulNoActions.g:134:4: is= ifBlock
					{
					...
					break;
				case 7 :
					// ./src/ulNoActions.g:135:4: wh= whileBlock
					{
					...
					break;
				case 8 :
					// ./src/ulNoActions.g:136:4: pl= printlnStmt
					{
					...
					break;
				case 9 :
					// ./src/ulNoActions.g:137:4: ps= printStmt
					{
					...
					break;
				case 10 :
					// ./src/ulNoActions.g:138:4: ret= returnStmt
					{
	...
	// ./src/ulNoActions.g:142:1: whileBlock returns [WhileStmt wh] : WHILE '(' e= expr ')' b= block ;
	public final WhileStmt whileBlock() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:143:2: ( WHILE '(' e= expr ')' b= block )
			// ./src/ulNoActions.g:143:4: WHILE '(' e= expr ')' b= block
			{
	...
	// ./src/ulNoActions.g:147:1: printlnStmt returns [PrintlnStmt pl] : PRINTLN e= expr ';' ;
	public final PrintlnStmt printlnStmt() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:148:2: ( PRINTLN e= expr ';' )
			// ./src/ulNoActions.g:148:4: PRINTLN e= expr ';'
			{
	...
	// ./src/ulNoActions.g:152:1: printStmt returns [PrintStmt p] : PRINT e= expr ';' ;
	public final PrintStmt printStmt() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:153:2: ( PRINT e= expr ';' )
			// ./src/ulNoActions.g:153:4: PRINT e= expr ';'
			{
	...
	// ./src/ulNoActions.g:157:1: returnStmt returns [ReturnStmt ret] : RETURN (e= expr )? ';' ;
	public final ReturnStmt returnStmt() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:164:2: ( RETURN (e= expr )? ';' )
			// ./src/ulNoActions.g:164:4: RETURN (e= expr )? ';'
			{
			match(input,RETURN,FOLLOW_RETURN_in_returnStmt654); if (state.failed) return ret;
			// ./src/ulNoActions.g:164:11: (e= expr )?
			int alt8=2;
			...
			switch (alt8) {
				case 1 :
					// ./src/ulNoActions.g:164:12: e= expr
					{
	...
	// ./src/ulNoActions.g:168:1: semiColon returns [SemiStatement st] : ';' ;
	public final SemiStatement semiColon() throws RecognitionException {
		SemiStatement st = null;


		try {
			// ./src/ulNoActions.g:169:2: ( ';' )
			// ./src/ulNoActions.g:169:4: ';'
			{
	...
	// ./src/ulNoActions.g:173:1: exprColon returns [ExColonStmt ec] : e= expr ';' ;
	public final ExColonStmt exprColon() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:174:2: (e= expr ';' )
			// ./src/ulNoActions.g:174:4: e= expr ';'
			{
	...
	// ./src/ulNoActions.g:178:1: arrayAssign returns [ArrayAssignStmt aas] : id= identifier '[' e1= expr ']' '=' e2= expr ';' ;
	public final ArrayAssignStmt arrayAssign() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:180:2: (id= identifier '[' e1= expr ']' '=' e2= expr ';' )
			// ./src/ulNoActions.g:180:4: id= identifier '[' e1= expr ']' '=' e2= expr ';'
			{
	...
	// ./src/ulNoActions.g:185:1: idAssign returns [IdAssignStmt idas] : id= identifier '=' e= expr ';' ;
	public final IdAssignStmt idAssign() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:186:2: (id= identifier '=' e= expr ';' )
			// ./src/ulNoActions.g:186:4: id= identifier '=' e= expr ';'
			{
	...
	// ./src/ulNoActions.g:190:1: ifElseBlock returns [IfElseStmt ie] : IF '(' e= expr ')' b1= block ELSE b2= block ;
	public final IfElseStmt ifElseBlock() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:191:2: ( IF '(' e= expr ')' b1= block ELSE b2= block )
			// ./src/ulNoActions.g:191:4: IF '(' e= expr ')' b1= block ELSE b2= block
			{
	...
	// $ANTLR start "ifBlock"
	// ./src/ulNoActions.g:196:1: ifBlock returns [IfStmt is] : IF '(' e= expr ')' b= block ;
	public final IfStmt ifBlock() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:197:2: ( IF '(' e= expr ')' b= block )
			// ./src/ulNoActions.g:197:4: IF '(' e= expr ')' b= block
			{
	...
	// $ANTLR start "block"
	// ./src/ulNoActions.g:201:1: block returns [Block blok] : '{' (s= statement )* '}' ;
	...
	// $ANTLR start "expr"
	// ./src/ulNoActions.g:212:1: expr returns [Expression e] : it= compareExpr ;
	public final Expression expr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:214:2: (it= compareExpr )
			// ./src/ulNoActions.g:214:4: it= compareExpr
			{
	...
	// ./src/ulNoActions.g:218:1: compareExpr returns [Expression e] : le= lessExpr ( '==' ri= lessExpr )* ;
	public final Expression compareExpr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:230:2: (le= lessExpr ( '==' ri= lessExpr )* )
			// ./src/ulNoActions.g:230:4: le= lessExpr ( '==' ri= lessExpr )*
			{
			...
			// ./src/ulNoActions.g:230:31: ( '==' ri= lessExpr )*
			loop10:
			while (true) {
				int alt10=2;
				...
				switch (alt10) {
				case 1 :
					// ./src/ulNoActions.g:230:32: '==' ri= lessExpr
					{
	...
	// ./src/ulNoActions.g:233:1: lessExpr returns [Expression e] : le= plmiExpr ( '<' ri= plmiExpr )* ;
	public final Expression lessExpr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:245:2: (le= plmiExpr ( '<' ri= plmiExpr )* )
			// ./src/ulNoActions.g:245:4: le= plmiExpr ( '<' ri= plmiExpr )*
			{
			...
			if (state.failed) return e;
			if ( state.backtracking==0 ) { it = le; }
			// ./src/ulNoActions.g:245:31: ( '<' ri= plmiExpr )*
			loop11:
			while (true) {
				int alt11=2;
				...
				switch (alt11) {
				case 1 :
					// ./src/ulNoActions.g:245:32: '<' ri= plmiExpr
					{
	...
	// ./src/ulNoActions.g:249:1: plmiExpr returns [Expression e] : le= multExpr ( (symbol= '+' ri= multExpr ) | (symbol= '-' ri= multExpr ) )* ;
	public final Expression plmiExpr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:260:2: (le= multExpr ( (symbol= '+' ri= multExpr ) | (symbol= '-' ri= multExpr ) )* )
			// ./src/ulNoActions.g:260:4: le= multExpr ( (symbol= '+' ri= multExpr ) | (symbol= '-' ri= multExpr ) )*
			{
			...
			if (state.failed) return e;
			if ( state.backtracking==0 ) { it = le; }
			// ./src/ulNoActions.g:261:2: ( (symbol= '+' ri= multExpr ) | (symbol= '-' ri= multExpr ) )*
			loop12:
			while (true) {
				int alt12=3;
				...
				switch (alt12) {
				case 1 :
					// ./src/ulNoActions.g:261:3: (symbol= '+' ri= multExpr )
					{
					// ./src/ulNoActions.g:261:3: (symbol= '+' ri= multExpr )
					// ./src/ulNoActions.g:261:5: symbol= '+' ri= multExpr
					{
					...
					break;
				case 2 :
					// ./src/ulNoActions.g:263:4: (symbol= '-' ri= multExpr )
					{
					// ./src/ulNoActions.g:263:4: (symbol= '-' ri= multExpr )
					// ./src/ulNoActions.g:263:6: symbol= '-' ri= multExpr
					{
	...
	// ./src/ulNoActions.g:268:1: multExpr returns [Expression e] : le= atom ( '*' ri= atom )* ;
	public final Expression multExpr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:279:2: (le= atom ( '*' ri= atom )* )
			// ./src/ulNoActions.g:279:4: le= atom ( '*' ri= atom )*
			{
			...
			if (state.failed) return e;
			if ( state.backtracking==0 ) { it = le; }
			// ./src/ulNoActions.g:279:27: ( '*' ri= atom )*
			loop13:
			while (true) {
				int alt13=2;
				...
				switch (alt13) {
				case 1 :
					// ./src/ulNoActions.g:279:28: '*' ri= atom
					{
	...
	// $ANTLR start "atom"
	// ./src/ulNoActions.g:283:1: atom returns [Expression e] : (l= literal |id= identifier |fc= functionCall |ar= arrayRef |pe= parenExpr );
	public final Expression atom() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:284:2: (l= literal |id= identifier |fc= functionCall |ar= arrayRef |pe= parenExpr )
			int alt14=5;
			switch ( input.LA(1) ) {
			case BOOL:
			case CHARACTERCONSTANT:
			...
			switch (alt14) {
				case 1 :
					// ./src/ulNoActions.g:284:4: l= literal
					{
					...
					break;
				case 2 :
					// ./src/ulNoActions.g:285:4: id= identifier
					{
					...
					break;
				case 3 :
					// ./src/ulNoActions.g:286:4: fc= functionCall
					{
					...
					break;
				case 4 :
					// ./src/ulNoActions.g:287:4: ar= arrayRef
					{
					...
					break;
				case 5 :
					// ./src/ulNoActions.g:288:4: pe= parenExpr
					{
	...
	// ./src/ulNoActions.g:291:1: functionCall returns [FunctionCall fc] : id= identifier '(' e1= expr ( ',' e2= expr )* ')' ;
	public final FunctionCall functionCall() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:297:2: (id= identifier '(' e1= expr ( ',' e2= expr )* ')' )
			// ./src/ulNoActions.g:297:4: id= identifier '(' e1= expr ( ',' e2= expr )* ')'
			{
			...
			if ( state.backtracking==0 ) { fc.setId(id);
								 fc.addExpr(e1); }
			// ./src/ulNoActions.g:301:4: ( ',' e2= expr )*
			loop15:
			while (true) {
				int alt15=2;
				...
				switch (alt15) {
				case 1 :
					// ./src/ulNoActions.g:301:5: ',' e2= expr
					{
	...
	// ./src/ulNoActions.g:304:1: arrayRef returns [Expression e] : id= identifier '[' e1= expr ']' ;
	public final Expression arrayRef() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:305:2: (id= identifier '[' e1= expr ']' )
			// ./src/ulNoActions.g:305:4: id= identifier '[' e1= expr ']'
			{
	...
	// ./src/ulNoActions.g:308:1: parenExpr returns [Expression e] : '(' e1= expr ')' ;
	public final Expression parenExpr() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:309:2: ( '(' e1= expr ')' )
			// ./src/ulNoActions.g:309:4: '(' e1= expr ')'
			{
	...
	// $ANTLR start "literal"
	// ./src/ulNoActions.g:319:1: literal returns [Literal l] : (il= integerconstant |fl= floatconstant |bl= bool |sl= stringconstant |cl= characterconstant );
	public final Literal literal() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:320:2: (il= integerconstant |fl= floatconstant |bl= bool |sl= stringconstant |cl= characterconstant )
			int alt16=5;
			switch ( input.LA(1) ) {
			case INTEGERCONSTANT:
				{
			...
			switch (alt16) {
				case 1 :
					// ./src/ulNoActions.g:320:4: il= integerconstant
					{
					pushFollow(FOLLOW_integerconstant_in_literal1351);
					il=integerconstant();
					state._fsp--;
					...
					break;
				case 2 :
					// ./src/ulNoActions.g:321:4: fl= floatconstant
					{
					pushFollow(FOLLOW_floatconstant_in_literal1362);
					fl=floatconstant();
					state._fsp--;
					if (state.failed) return l;
					...
					break;
				case 3 :
					// ./src/ulNoActions.g:322:4: bl= bool
					{
					pushFollow(FOLLOW_bool_in_literal1373);
					bl=bool();
					state._fsp--;
					if (state.failed) return l;
					...
					break;
				case 4 :
					// ./src/ulNoActions.g:323:4: sl= stringconstant
					{
					pushFollow(FOLLOW_stringconstant_in_literal1384);
					sl=stringconstant();
					state._fsp--;
					if (state.failed) return l;
					...
					break;
				case 5 :
					// ./src/ulNoActions.g:324:4: cl= characterconstant
					{
					pushFollow(FOLLOW_characterconstant_in_literal1395);
	...
	// ./src/ulNoActions.g:328:1: stringconstant returns [StringLiteral sl] : s= STRINGCONSTANT ;
	public final StringLiteral stringconstant() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:330:2: (s= STRINGCONSTANT )
			// ./src/ulNoActions.g:330:4: s= STRINGCONSTANT
			{
			s=(Token)match(input,STRINGCONSTANT,FOLLOW_STRINGCONSTANT_in_stringconstant1419); if (state.failed) return sl;
	...
	// ./src/ulNoActions.g:334:1: floatconstant returns [FloatLiteral fl] : f= FLOATCONSTANT ;
	public final FloatLiteral floatconstant() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:336:2: (f= FLOATCONSTANT )
			// ./src/ulNoActions.g:336:4: f= FLOATCONSTANT
			{
			f=(Token)match(input,FLOATCONSTANT,FOLLOW_FLOATCONSTANT_in_floatconstant1443); if (state.failed) return fl;
	...
	// ./src/ulNoActions.g:340:1: characterconstant returns [CharLiteral cl] : c= CHARACTERCONSTANT ;
	public final CharLiteral characterconstant() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:342:2: (c= CHARACTERCONSTANT )
			// ./src/ulNoActions.g:342:4: c= CHARACTERCONSTANT
			{
			c=(Token)match(input,CHARACTERCONSTANT,FOLLOW_CHARACTERCONSTANT_in_characterconstant1467); if (state.failed) return cl;
	...
	// ./src/ulNoActions.g:346:1: integerconstant returns [IntegerLiteral il] : i= INTEGERCONSTANT ;
	public final IntegerLiteral integerconstant() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:348:2: (i= INTEGERCONSTANT )
			// ./src/ulNoActions.g:348:4: i= INTEGERCONSTANT
			{
			i=(Token)match(input,INTEGERCONSTANT,FOLLOW_INTEGERCONSTANT_in_integerconstant1491); if (state.failed) return il;
	...
	// $ANTLR start "bool"
	// ./src/ulNoActions.g:352:1: bool returns [BooleanLiteral bl] : b= BOOL ;
	public final BooleanLiteral bool() throws RecognitionException {
		...
		try {
			// ./src/ulNoActions.g:354:2: (b= BOOL )
			// ./src/ulNoActions.g:354:4: b= BOOL
			{
			b=(Token)match(input,BOOL,FOLLOW_BOOL_in_bool1515); if (state.failed) return bl;
	...
	public static final BitSet FOLLOW_integerconstant_in_literal1351 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_floatconstant_in_literal1362 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_bool_in_literal1373 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_stringconstant_in_literal1384 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_characterconstant_in_literal1395 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_STRINGCONSTANT_in_stringconstant1419 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FLOATCONSTANT_in_floatconstant1443 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHARACTERCONSTANT_in_characterconstant1467 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTEGERCONSTANT_in_integerconstant1491 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BOOL_in_bool1515 = new BitSet(new long[]{0x0000000000000002L});
